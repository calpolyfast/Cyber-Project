    ...
    return <div className="flex bg-primary justify-center w-full h-full">
        <div className="flex h-full flex-col gap-2 p-4 items-center bg-white">
            ...
            <div className="flex flex-2 flex-col gap-2">
                <button className="font-bold font-serif p-2 hover:bg-primary bg-[#888] text-black hover:text-white text-xl rounded-sm" onClick={handleCreateChamber}>Launch</button>
